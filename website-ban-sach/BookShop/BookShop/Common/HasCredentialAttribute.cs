...
namespace BookShop
{
    public class HasCredentialAttribute : AuthorizeAttribute
    {
        ...
        protected override bool AuthorizeCore(HttpContextBase httpContext)
        {
            ...
            var cartSession = (UserLogin)HttpContext.Current.Session[Common.CommonConstants.CartSession];
            if (cartSession == null)
            {
                return false;
            }
            ...
            if (privilegeLevels.Contains(this.RoleID) /*|| session.GroupID == ComonConst.ADMIN_GROUP*/)
            {
                return true;
            }
            else
